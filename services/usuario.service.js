...
*/
    async recuperarSenha(email) {
        ...
        if (user) {
            // TODO -> criar senha aleatoria e alterar no banco OU enviar link para alterar senha

            let emailEnviado = await this._enviaEmailRecuperacao(email, user.nome, "123456789");
...
*/
    async _enviaEmailRecuperacao(email, nome, senha) {
        ...
        * {
        ...
        <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">Ola, ${nome}</span></p>
        <p style="font-size: 14px; line-height: 140%;"> </p>
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">Recebemos uma solicitação para recuperação de senha. </span></p>
        <p style="font-size: 14px; line-height: 140%;"> </p>
        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">Aqui está uma senha temporária para acessar sua conta: </span></p>
        </div>
        ...
        <div style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="line-height: 140%;"><span style="color: #000000; line-height: 28px; font-size: 20px;">${senha}</span></p>
        </div>
